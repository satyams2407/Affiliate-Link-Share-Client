...
// Core javascript library (not specific to React) for rendering charts.
import {
    Chart as ChartJS,
    BarElement,
    CategoryScale,
...
const AnalyticsDashboard = () => {
    ...
    const fetchLinkAnalytics = async () => {
        try{
            ...
            console.log(error);
            //Navigate to error page if  we are not able to fetch the link analytics.
            //This is because there is not point rendering the component if we don't have any data.
            navigate('/error');
        }
    }
  ...
  return (
    <div className='container py-5'>
        ...
        <div className='row mb-5 mx-0 border py-3 rounded'>
